...
public class TestTextAbstract {
    ...
    private static final String HEALTH_TIPS_ROLE = "你是一个健康知识库";

    private static final String HEALTH_TIPS_CONTENT = "每次都随机提供30到50字内的大白话健康小知识，重点指向食物领域的";
     ...
     * 获取健康小知识
     */
    public static StringBuilder getHealthTips() {
        return extracted(HEALTH_TIPS_ROLE, HEALTH_TIPS_CONTENT);
    }
